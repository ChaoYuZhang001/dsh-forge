...
Source, schemas, tests, sanitized fixtures, generated documentation, checksums, SBOMs, Action metadata, and the compiled Action distribution may be public. Release tags must match the package version, for example `v0.2.0-alpha.1`.
